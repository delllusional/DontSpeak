...
mod tests {
    ...
    fn claude_toml_hooks_wires_and_is_idempotent() {
        ...
        assert_eq!(
            claude_toml_hooks(&cfg, WiredAgent::Codex, false, false, &paths, None, None),
            0
        );
    ...
    fn claude_toml_hooks_remove_strips_previously_wired_hooks() {
        ...
        assert_eq!(
            claude_toml_hooks(&cfg, WiredAgent::Codex, true, false, &paths, None, None),
            0
        );
    ...
    fn claude_toml_hooks_print_only_writes_nothing() {
        ...
        assert_eq!(
            claude_toml_hooks(&cfg, WiredAgent::Codex, false, true, &paths, None, None),
            0
        );
        assert!(!cfg.exists());
    }
    ...
    fn kimi_toml_hooks_wires_and_is_idempotent() {
        ...
        assert_eq!(
            kimi_toml_hooks(&cfg, WiredAgent::KimiCode, false, false, &paths, None, None),
            0
        );
        let first = std::fs::read_to_string(&cfg).unwrap();
    ...
    fn kimi_toml_hooks_remove_strips_previously_wired_hooks() {
        ...
        assert_eq!(
            kimi_toml_hooks(&cfg, WiredAgent::KimiCode, true, false, &paths, None, None),
            0
        );
    ...
    fn kimi_toml_hooks_print_only_writes_nothing() {
        ...
        assert_eq!(
            kimi_toml_hooks(&cfg, WiredAgent::KimiCode, false, true, &paths, None, None),
            0
        );
        assert!(!cfg.exists());
    }
