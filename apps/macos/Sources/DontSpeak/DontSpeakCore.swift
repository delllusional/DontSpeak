...
struct TtsStatsDTO: Decodable {
    var rtfAvg: Double?
    var rtfMin: Double?
    var rtfMax: Double?
    var firstAvgMs: Double?
    var firstMinMs: Double?
    var firstMaxMs: Double?
    var utterances: Int?
    var audioSecs: Double?
    var failures: Int?
...
struct LifetimeStatsDTO: Decodable {
    var ttsSecs: Double?
    var sttSecs: Double?
