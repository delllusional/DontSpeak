...
internal sealed class TrayIcon : IDisposable
{
    ...
    public static bool AutostartEnabled()
    {
        ...
        catch { return false; } // registry blocked (policy/AV/sandbox) → report disabled
    }
    ...
    public static void ToggleAutostart()
    {
        ...
        catch { /* registry blocked (policy/AV/sandbox) — no-op, matching PromoteInTray's fail-soft */ }
    }
